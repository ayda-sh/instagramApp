...
const PostCard = () => {
    ...
    return (
      ...
      <div class="max-w-lg mx-auto bg-white rounded-lg shadow-md overflow-hidden px-6"> 
    ...
    <div class="p-4">  
        ...
        <div class="flex flex-col gap-y-3 items-start mt-[10px]"> 
          <span class="flex gap-x-4">
            <img class="size-5" src="/public/heart.svg" alt="like" />
            <img class="size-5"  src="/public/comment.svg" alt="comment" />
          </span>
          <span>
            <p class="font-[8px] text-[#262626] tracking-tight">741 likes</p>
          </span>
        </div>
        <div class="flex gap-x-1">
